    ...
    useEffect(
        () => {
            Axios.get('http://localhost:3001/api/usuarios/' + id)
                .then((response) => {
                    setUsuarioNombre(response.data.name);
                    setUsuarioRol(response.data.role);
                    setUsuarioDireccion(response.data.address);
                })
                        ...
                        <div className="col-md-3">
                            ...
                            <div className="card card-primary card-outline">
                                <div className="card-body box-profile">
                                    ...
                                    <h3 className="profile-username text-center">{usuarioNombre}</h3>
                                    <p className="text-muted text-center">{usuarioRol}</p>
                            ...
                            <div className="card card-primary">
                                ...
                                <div className="card-body">
                                    ...
                                    <p className="text-muted">{usuarioDireccion}</p>
                                    <hr />
